...
/*static*/ const unsigned long OutilsCreationImage::BI_CHAMPS_BITS = 3; // méthode de compression : pas de compression car les pixels sont codés sur 32 bits
...
const unsigned long methodeCompression = BI_CHAMPS_BITS; // 3; // correspond à BI_CHAMPS_BITS,
