...
static const unsigned long BI_CHAMPS_BITS; // = 3; // méthode de compression : pas de compression car les pixels sont codés sur 32 bits
 ...
 *
 * déjà écrit dans OutilsChargementImage
 *
 * */
/*
template <class T>
 ...
 *
 * et la méthode de compression est BI_CHAMPS_BITS
